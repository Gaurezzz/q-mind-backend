...
class BrusEngine(Cell):
    ...
    def __init__(self, 
        ...
        self.sigma = 30  # Standard deviation for absorption profile [nm]

        logger.debug(
            "BrusEngine ready | Eg0=%.4f eV  α=%.2e  β=%.1f K  "
            "me*=%.3f  mh*=%.3f  εr=%.2f  α_max=%.2e m⁻¹",
            bandgap, alpha, beta, me_eff, mh_eff, eps_r, max_absorption_coefficient,
        )
